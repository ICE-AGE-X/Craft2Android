...
Attrib sky_attrib = {0};
double last_commit = 0;//glfwGetTime();
double last_update = 0;//glfwGetTime();
GLuint sky_buffer = 0;//gen_sky_buffer();
int init_main(int width, int height) {
...
//    } else
    ...
    s->z=100;
    g->player_count = 1;
    s->y = 20;//highest_block(s->x, s->z) + 2;
    // OUTER LOOP //
//    glfwTerminate();
//    curl_global_cleanup();
    return 0;
